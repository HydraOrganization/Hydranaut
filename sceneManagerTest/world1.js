...
function World1()
{
  var me = this;
    ...
    //create playerPiece
    player = createSprite(((window.displayWidth/4)+400),(window.displayHeight/4)+400);
    ...
    {
      //
        image(this.sceneManager.worldMap1, 0, 0, window.displayWidth, window.displayHeight);//display the board image
        player.visible = true;
        //create nodes
